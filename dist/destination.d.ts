...
export declare function readSubaccountDestinations2<T extends IDestinationConfiguration>(authorizationHeader?: string, subscribedSubdomain?: string, regex?: string): Promise<T[]>;
